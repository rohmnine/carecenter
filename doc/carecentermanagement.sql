...
CREATE TABLE `admin`  (
  ...
  `center_building_id` int(11) NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `username`(`username`) USING BTREE,
  INDEX `idx_center_building_id`(`center_building_id`) USING BTREE
...
INSERT INTO `admin` VALUES (3, 'center1', '$2a$10$.n6ychQOHJACd//uoJl/sugyWBEFhU7kYuktdvB/TTf7ciykVDQx2', '张三', 35, '男', '15222223333', '12@email.com', 1, '2026-03-03 12:42:10', '2026-05-01 01:33:27');
INSERT INTO `admin` VALUES (4, 'center2', '123456', '李四', 55, '女', '15333332222', NULL, 2, '2026-03-03 12:42:10', '2026-03-03 12:42:10');
INSERT INTO `admin` VALUES (5, 'center3', '123456', '王五', 38, '男', '15855552222', NULL, 3, '2026-03-03 12:42:10', '2026-03-03 12:42:10');
INSERT INTO `admin` VALUES (6, 'center4', '123456', '赵花', 40, '女', '15877776666', NULL, 4, '2026-03-03 12:42:10', '2026-03-03 12:42:10');
...
CREATE TABLE `center_building`  (
  `center_building_id` int(11) NOT NULL COMMENT '分店编号',
  `center_building_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分店名称',
  `center_building_detail` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分店备注',
...
CREATE TABLE `center_room`  (
  `center_room_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '房间号',
  `center_building_id` int(11) NOT NULL COMMENT '分店编号',
  ...
  PRIMARY KEY (`center_room_id`) USING BTREE
...
CREATE TABLE `center_room_bed`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_room_bed`(`center_room_id`, `bed_no`) USING BTREE,
  INDEX `idx_room`(`center_room_id`) USING BTREE,
  INDEX `idx_occupant`(`occupant_username`) USING BTREE,
  CONSTRAINT `fk_center_room_bed_room` FOREIGN KEY (`center_room_id`) REFERENCES `center_room` (`center_room_id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 33 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分店床位明细表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `notice` VALUES (2, '关于分店卫生的新规定', '<p>学生公寓是学生们主要的生活区域，兼具休息、学习、交际等多种功能，是培养、提升学生全面素质不可或缺的重要阵地。为了培养学生良好的行为素养和生活习惯，我们实行分店长内务准军事化管理，切实把学生公寓建成学生自我教育，自我管理和自我服务的家园。</p>', '大强', '2026-02-08 06:02:59');
...
INSERT INTO `user` VALUES (4, 'center1', '$2a$10$.n6ychQOHJACd//uoJl/sugyWBEFhU7kYuktdvB/TTf7ciykVDQx2', '张三', 35, '男', '15222223333', '12@email.com', 'admin', NULL, NULL, 1, '2026-03-03 12:42:10', '2026-05-01 01:33:27');
INSERT INTO `user` VALUES (5, 'center2', '123456', '李四', 55, '女', '15333332222', NULL, 'admin', NULL, NULL, 2, '2026-03-03 12:42:10', '2026-03-03 12:42:10');
INSERT INTO `user` VALUES (6, 'center3', '123456', '王五', 38, '男', '15855552222', NULL, 'admin', NULL, NULL, 3, '2026-03-03 12:42:10', '2026-03-03 12:42:10');
INSERT INTO `user` VALUES (7, 'center4', '123456', '赵花', 40, '女', '15877776666', NULL, 'admin', NULL, NULL, 4, '2026-03-03 12:42:10', '2026-03-03 12:42:10');
