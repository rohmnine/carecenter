...
export default {
    ...
    methods: {
        ...
        saveStatusReport() {
            ...
            const payload = {
                studentUsername: this.reportForm.studentUsername,
                reportDate: this.reportForm.reportDate,
                restStatus: this.reportForm.restStatus,
                mealStatus: this.reportForm.mealStatus,
                moodStatus: this.reportForm.moodStatus,
                healthStatus: this.reportForm.healthStatus,
                remark: this.reportForm.remark,
                reporterUsername: currentUser ? currentUser.username : ""
            }
            request.post("/studentStatus/upsert", payload).then((res) => {
                if (res.code === "0") {
                    ElMessage({
                        message: "学生状况已保存",
                        type: "success",
