    ...
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column label="房间号" prop="centerRoomId"/>
          ...
          <el-table-column label="操作" width="200px">
            <template #default="scope">
              ...
              <el-button type="success" plain @click="openStatusDialog(scope.row)">状况</el-button>
        ...
        <div>
          ...
          <el-dialog v-model="reportDialogVisible" title="学生状况报告" width="40%">
            <el-form ref="reportFormRef" :model="reportForm" label-width="100px">
              <el-form-item label="学生">
                <el-input v-model="reportForm.studentUsername" disabled style="width: 80%"></el-input>
              </el-form-item>
              ...
              <el-form-item label="休息状况">
                <el-select v-model="reportForm.restStatus" style="width: 80%">
                  <el-option label="良好" value="good"></el-option>
                  <el-option label="正常" value="normal"></el-option>
                  <el-option label="较差" value="poor"></el-option>
                </el-select>
              </el-form-item>
              <el-form-item label="就餐状况">
                <el-select v-model="reportForm.mealStatus" style="width: 80%">
                  <el-option label="良好" value="good"></el-option>
                  <el-option label="正常" value="normal"></el-option>
                  <el-option label="较差" value="poor"></el-option>
                </el-select>
              ...
              <el-form-item label="情绪状况">
                <el-select v-model="reportForm.moodStatus" style="width: 80%">
                  <el-option label="良好" value="good"></el-option>
                  <el-option label="正常" value="normal"></el-option>
                  <el-option label="较差" value="poor"></el-option>
                </el-select>
              ...
              <el-form-item label="健康状况">
                <el-select v-model="reportForm.healthStatus" style="width: 80%">
                  <el-option label="良好" value="good"></el-option>
                  <el-option label="正常" value="normal"></el-option>
                  <el-option label="较差" value="poor"></el-option>
                </el-select>
            ...
            <template #footer>
              <span class="dialog-footer">
                ...
                <el-button type="primary" @click="saveStatusReport">保 存</el-button>
              </span>
            </template>
          </el-dialog>
        </div>
