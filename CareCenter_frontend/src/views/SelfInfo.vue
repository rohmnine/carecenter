            ...
            <div style="display: flex">
                <div style="width: 600px; margin-left: 30px; position: relative">
                    <el-descriptions :column="1" :size="large" border style="min-width: 500px" title="">
                        ...
                        <el-descriptions-item v-if="identity === 'parent'">
                            <template #label>
                                <div>
                                    <el-icon>
                                        <user/>
                            ...
                            <span v-if="studentUsernames && studentUsernames.length">
                                {{ studentUsernames.join('、') }}
                            </span>
            ...
            <div>
                ...
                <el-dialog v-model="dialogVisible" title="操作" width="30%" @close="cancel">
                    <el-form ref="form" :model="form" :rules="rules" label-width="120px">
                        ...
                        <el-form-item v-if="identity === 'parent'" label="绑定学生" prop="studentUsernames">
                            <el-select
